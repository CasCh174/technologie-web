...
<body>
	...
	<p>
		<form method="post" action="index.php?page=1">
			...
			<p> <label for="destination"> Destination : </label> <input autofocus type="text" name="destination" id = "destination" value=<?php echo $_SESSION["reservation"]->getDestination();?>  > </p>
			<p> <label for="seats"> Nombre de places : </label> <input type="text" name="seats" id = "seats" value=<?php echo $_SESSION["reservation"]->getSeats();?>  > </p>
